...
EOF
  ...
  assert_equals false "$ENABLE_OPENCODE_SERVICE" ENABLE_OPENCODE_SERVICE
  assert_equals true "$INSTALL_HERMES_AGENT" INSTALL_HERMES_AGENT
  assert_equals true "$ENABLE_HERMES_DASHBOARD_SERVICE" ENABLE_HERMES_DASHBOARD_SERVICE
  ...
  assert_equals false "$ENABLE_HERMES_DASHBOARD_SERVICE" INTERACTIVE_ENABLE_HERMES_DASHBOARD_SERVICE
